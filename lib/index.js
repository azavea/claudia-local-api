...
function makeHandleRequest(logger, app, routes) {
    return function (req, res) {
        ...
        console.log(`API Config: ${JSON.stringify(app.apiConfig())}`);
        ...
        const currentPath = requestContext.resourcePath.slice(1);
        const currentHTTPMethod = requestContext.httpMethod;
        const convertToBinary = _.get(app.apiConfig(), `routes.${currentPath}.${currentHTTPMethod}.success.contentHandling`, false);
