...
function parseContentHandling(params, app) {
    ...
    return _.get(app.apiConfig(), `routes.${currentPath}.${currentHTTPMethod}.success.contentHandling`, false);
}
...
function makeHandleRequest(logger, app, routes) {
    return function (req, res) {
        ...
        app.proxyRouter(params, {
            done: makeHandleResponse(logger, res, parseContentHandling(params, app))
        });
    };
}
